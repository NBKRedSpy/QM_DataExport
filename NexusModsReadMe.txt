[b][size=5]Quasimorph Data Export[/size][/b] 
 
 
Extracts the game's config_* data to the app data folder.
 
The data can be found at [font=Courier New]%AppData%\..\LocalLow\Magnum Scriptum Ltd\Quasimorph\QM_DataExport\Data[/font]. with the extension of .tsv.
